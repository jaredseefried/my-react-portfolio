        ...
        <div className="col-4 card-div">
          <div className="card portfolio-card">
            ...
            <div className="card-body body-card">
              ...
              <a href="https://my-pandemic-tracker.herokuapp.com/" target="_blank" className="card-text port-card-text">A MERN (Mongo, Express, React and Node) Application using React-Globe and API's to show updated stats on Covid-19. </a>          
            </div>
          </div>
        </div>
        <div className="col-4 card-div">
